...
#define QT_MOC_LITERAL(ofs, len)                                    \
  uint(sizeof(qt_meta_stringdata_CLASSs21SCOPEGameBoardENDCLASS_t:: \
                  offsetsAndSizes) +                                \
       ofs),                                                        \
      len
Q_CONSTINIT static const qt_meta_stringdata_CLASSs21SCOPEGameBoardENDCLASS_t
    qt_meta_stringdata_CLASSs21SCOPEGameBoardENDCLASS = {
        {
            QT_MOC_LITERAL(0, 14),   // "s21::GameBoard"
            QT_MOC_LITERAL(15, 12),  // "scoreChanged"
            QT_MOC_LITERAL(28, 0),   // ""
            QT_MOC_LITERAL(29, 5),   // "score"
            QT_MOC_LITERAL(35, 12),  // "levelChanged"
            QT_MOC_LITERAL(48, 5),   // "level"
            QT_MOC_LITERAL(54, 16),  // "highScoreChanged"
            QT_MOC_LITERAL(71, 9),   // "highScore"
            QT_MOC_LITERAL(81, 16)   // "gameOverOccurred"
        },
        "s21::GameBoard",
        "scoreChanged",
        "",
